...
// netlify/functions/fetchNews/fetchNews.ts
var fetchNews_exports = {};
__export(fetchNews_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(fetchNews_exports);
...
var handler = async (event) => {
  try {
    ...
    const getSourceForCategory = (category2) => {
      const categorySources = {
        "world": "bbc-news",
        "us-news": "cnn",
        "sports": "espn"
      };
      return categorySources[category2] || "bbc-news";
    };
    const sources = getSourceForCategory(category);
    const apiUrl = `https://newsapi.org/v2/top-headlines?apiKey=${apiKey}&sources=${sources}`;
